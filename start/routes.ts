...
router
  .group(() => {
    ...
    router.post('/admin/coach-pricings',          [AdminController, 'createCoachPricing'])
    router.patch('/admin/coach-pricings/:id',     [AdminController, 'updateCoachPricing'])
    router.delete('/admin/coach-pricings/:id',    [AdminController, 'deleteCoachPricing'])
  })
